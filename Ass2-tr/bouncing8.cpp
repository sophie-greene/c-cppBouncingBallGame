...
gen:   randomNoX=rand()% (xSumBtn-1) ; 
    ...
    {    
        ...
        {      
           ...
           {
           //find the quarter of the button of which the ball is approaching
           //top-right->1,topleft->2,buttom-left->3,buttom-right->4
               if (btnPosArray[cnt][0]>i && btnPosArray[cnt][1]>j)btnSide=2;
               else if (btnPosArray[cnt][0]<i && btnPosArray[cnt][1]<j)btnSide=3;
               else if (btnPosArray[cnt][0]<i && btnPosArray[cnt][1]>j)btnSide=1;
               else if (btnPosArray[cnt][0]>i && btnPosArray[cnt][1]<j)btnSide=4;
               tag = cnt;
               if ((abs(ydir)/ydir)==1 && (abs(xdir)/xdir)==1) 
               {
                  if (btnSide==1 ) ydir = -1*(int(rand()%NumberOfRand )+1);
                  else if (btnSide==2)xdir = -1*(int(rand()%NumberOfRand )+1);
                  else if (btnSide==3)xdir = -1*(int(rand()%NumberOfRand )+1);
                  else if (btnSide==4)xdir = -1*(int(rand()%NumberOfRand )+1);
               }
               else if ((abs(ydir)/ydir==1) && (abs(xdir)/xdir)==-1) 
               {
                    if (btnSide==1)
                    {
                     
                     ydir = -1*(int(rand()%NumberOfRand )+1);
                     }
                   else if (btnSide==2)ydir = -1*(int(rand()%NumberOfRand )+1);
                   else if (btnSide==3)xdir = (int(rand()%NumberOfRand )+1);
                   else if (btnSide==4)xdir =(int(rand()%NumberOfRand )+1);
               }
               else if ((abs(ydir)/ydir)==-1 && (abs(xdir)/xdir)==1) 
               {
                   if (btnSide==1) ydir = (int(rand()%NumberOfRand )+1);
                  else if (btnSide==2)xdir = -1*(int(rand()%NumberOfRand )+1);
                  else if (btnSide==3)
                  {
                       ydir =(int(rand()%NumberOfRand )+1);
                       xdir =-1*(int(rand()%NumberOfRand )+1);
                  }
                  else if (btnSide==4)ydir = (int(rand()%NumberOfRand )+1);
               }
               else if ((abs(ydir)/ydir)==-1 && (abs(xdir)/xdir)==-1) 
               {
                    if (btnSide==1) xdir = (int(rand()%NumberOfRand )+1);
                  else if (btnSide==2)xdir = -1*(int(rand()%NumberOfRand )+1);
                  else if (btnSide==3)ydir = (int(rand()%NumberOfRand )+1);
                  else if (btnSide==4)
                  {
                       ydir = (int(rand()%NumberOfRand )+1);
                       xdir = (int(rand()%NumberOfRand )+1);
